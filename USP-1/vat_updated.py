...
if __name__ == "__main__":
    ...
    for ticker in tickers:
        try:
            ...
            file_path = f"/Users/abhishekjoshi/Documents/GitHub/stock_forecasting_CAI/Data/{ticker}/{ticker}_merged_with_vix.csv"
            ...
            with torch.no_grad():
                ...
                output_file = f"evaluation_results_{ticker}.json"
